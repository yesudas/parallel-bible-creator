...
public interface BibleToDocLanguage {
	...
	public static String STR_FOLLOW_US = "Follow Us: ";
	public static String STR_YOUTUBE = "YouTube: ";
	public static String STR_YOUTUBE_TEXT = "Bible Minutes";
	public static String STR_YOUTUBE_URL = "https://www.youtube.com/c/BibleMinutes";
	...
	public static String SUB_TITLE_1_FONT = "SUB_TITLE_1_FONT";
	public static String SUB_TITLE_1_FONT_SIZE = "SUB_TITLE_1_FONT_SIZE";
	public static String SUB_TITLE_2 = "SUB_TITLE_2";
	public static String SUB_TITLE_2_FONT = "SUB_TITLE_2_FONT";
	public static String SUB_TITLE_2_FONT_SIZE = "SUB_TITLE_2_FONT_SIZE";
	public static String STR_INDEX_TITLE = "STR_INDEX_TITLE";
	public static String STR_INDEX_TITLE_FONT = "STR_INDEX_TITLE_FONT";
	public static String STR_INDEX_TITLE_FONT_SIZE = "STR_INDEX_TITLE_FONT_SIZE";
	public static String STR_INDEX_FONT = "STR_INDEX_FONT";
	public static String STR_INDEX_FONT_SIZE = "STR_INDEX_FONT_SIZE";
	...
	public static String STR_PDF_INDEX_ISSUE = "STR_PDF_INDEX_ISSUE";
	public static String STR_PDF_INDEX_ISSUE_ENGLISH = "STR_PDF_INDEX_ISSUE_ENGLISH";
	public static String STR_PDF_INDEX_ISSUE_FONT = "STR_PDF_INDEX_ISSUE_FONT";
	public static String STR_PDF_INDEX_ISSUE_FONT_SIZE = "STR_PDF_INDEX_ISSUE_FONT_SIZE";
	public static String STR_CREATOR = "STR_CREATOR";
	public static String BOOK_HEADING_FONT = "BOOK_HEADING_FONT";
	public static String BOOK_HEADING_FONT_SIZE = "BOOK_HEADING_FONT_SIZE";
	public static String CHAPTER_HEADING_FONT = "CHAPTER_HEADING_FONT";
	public static String CHAPTER_HEADING_FONT_SIZE = "CHAPTER_HEADING_FONT_SIZE";
